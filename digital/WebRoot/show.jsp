...
<!--主体开始-->
	<div class="main mt10">
		...
		<!--商品详细信息开始-->
		<div class="show_a fl">
			<div class="img fl"><img src="product_big_images/${requestScope.detailProductInfo.bigpic}"/></div>
			<div class="canshu fl">
				<p></p>
				<p>编号：${requestScope.detailProductInfo.code }</p>
				<p>品名：${requestScope.detailProductInfo.name }</p>
				<p>品牌：${requestScope.detailProductInfo.brand }</p>
				<p><font color="red">价格：${requestScope.detailProductInfo.price }</font></p>
				<p>库存：${requestScope.detailProductInfo.num }</p>
				<p></p>
				<p></p>
				<p></p>
				<p></p>
				<div class="pic">
					<div class="img fl">
						<div class="tupian"><img src="product_images/s${requestScope.detailProductInfo.pic }"/></div>
		...
		<!--商品详细信息结束-->
		<div class="show_b fl">
			<a href="addtoshopcart?productInfoId=${requestScope.detailProductInfo.id } "><img src="images/d010.jpg"/></a>	
		</div>
		<div class="show_c fl">产品详情</div>
		<div class="show_d fl ah">
			商品名称：<br/>
			${requestScope.detailProductInfo.name }<br/>
			商品简介：<br/>
			${requestScope.detailProductInfo.intro }
		</div>
		<div class="show_c fl">商品图片</div>
			<div class="show_e fl">
				<div class="yy fl"><img src="product_images/${requestScope.detailProductInfo.pic}"/></div>
				<div class="yy fl"><img src="product_images/${requestScope.detailProductInfo.pic}"/></div>
				<div class="yy fl"><img src="product_images/${requestScope.detailProductInfo.pic}"/></div>
			</div>
		</div>
